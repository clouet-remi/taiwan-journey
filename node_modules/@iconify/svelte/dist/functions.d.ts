 ...
 */
export declare function checkIconState(icon: string | IconifyIcon, state: IconState, callback: IconStateCallback, onload?: IconifyIconOnLoad): CheckIconStateResult | null;

/**
 * checkIconState result
 */
export declare interface CheckIconStateResult {
 ...
 * Generate icon
 */
export declare function generateIcon(icon: IconComponentData, props: IconProps): RenderResult | null;
...
declare type IconComponentData = IconifyIcon | null;
 ...
 */
declare interface IconLoadingState {
    name: string;
...
declare type IconStateCallback = () => void;
 ...
 */
export declare function replaceIDs(body: string): string;
